...
EXTERN ADDAPI void ADDCALL sha3_256(unsigned char* buf, unsigned long len, unsigned char* digest);
EXTERN ADDAPI void ADDCALL sha256(unsigned char* buf, unsigned long len, unsigned char* digest);
EXTERN ADDAPI void ADDCALL sha1begin(unsigned int* h);
EXTERN ADDAPI void ADDCALL sha1update(unsigned char* buf, unsigned long len, unsigned char* digest);
EXTERN ADDAPI void ADDCALL sha1finish(unsigned char* buf, unsigned long len, unsigned char* digest);
